...
public class Updater {
    ...
    public Updater(JHider plugin, Values values) {
        this.plugin = plugin;
    ...
    private void checkVersions() {
        try {
            URLConnection connection = new URL("https://github.com/mitriyf/JHider/raw/refs/heads/main/updater/versions.yml").openConnection();
